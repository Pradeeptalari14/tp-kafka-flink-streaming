# 🟠 Kafka & Flink Streaming Studio

> Orchestrate real-time message streams with Apache Kafka topics and stream-processing aggregations using Apache Flink SQL. Generate Flink SQL jobs, Python producers, and docker-compose services.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/kafka-flink-streaming/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chatbot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-kafka-flink-streaming.git
cd tp-kafka-flink-streaming
```
...
```bash
kubectl port-forward deployment/tp-kafka-flink-streaming 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── flink_job.sql     # Main configuration file
```
...
---
*Generated by [Kafka & Flink Streaming Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/kafka-flink-streaming/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
